    <!-- Modal Tambah Fraksi-->
    <div class="modal fade" id="tambahDewanModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
       aria-hidden="true">
       <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
             <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="exampleModalLabel">Form Tambah Data Dewan</h5>
                   ...
                   <div class="row">
                      <div class="form-group col-6">
                         ...
                         <select class="form-control" name="kd_fraksi" value="<?php echo old('kd_fraksi'); ?>">
                            ...
                            <option value="<?php echo $frks['kd_fraksi']; ?>" name="kd_fraksi">
                               <?php echo $frks['fraksi']; ?></option>
                            <?php }?>
                         </select>
                      </div>
                      <div class="form-group col-6">
